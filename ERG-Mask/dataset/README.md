...
The images folder contains grape-cluster images. The annotations folder contains the corresponding annotation files, including edge-label PNG files, label visualization files, and label-name information. The json_to_annotations.py, which is used to convert LabelMe JSON annotation files into the annotation files required for ERG-Mask, including label images, label-name files, visualization images, and edge-label images.
